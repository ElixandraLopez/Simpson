...
//Detectar la conexion a internet
function isOnline(){
    if(navigator.onLine){
...
function notificarme(){
    if(!window.Notification){
        console.log('navegador no soporta notificacion');
        return;
    }

    if (Notification.permission==='granted'){
        //new Notification('hola mundo - grented');
        enviarNotificaciones()
    
    }
    else if(Notification.permission!=='denied' || Notification.permission==='defaule'){
